...
public class CreateAccount  implements java.io.Serializable {
    ...
    /**
     * Gets the personID value for this CreateAccount.
     * 
     * @return personID
     */
    ...
    /**
     * Sets the personID value for this CreateAccount.
     * 
     * @param personID
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://PepiSystems.com/WS/PEPi", ">CreateAccount"));
